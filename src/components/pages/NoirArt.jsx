    ...
    return(
        <>
            <div
              ...
              <div className="subheader"><h2 className='ml-6 text-white text-center text-2xl'>A Black Owned Directory</h2>
              </div>
        ...
        {mydata.map((item, index) => {
          return (
            <>
             ...
             <div key={index} >
             <div className="flex flex-col items-center m-5 p-2.5 border-4 m-auto rounded-3xl rounded-tl border-white w-[400px] h-[320px] bg-amber-900 bg-opacity-80">
  <img src={item.image_Url} alt="item" className="rounded-3xl rounded-tl w-full h-full object-contain" />
</div>
             <div className='gallery-description'><div className='ems-center text-2xl text-white'>
              ...
              <button className="m-auto w-14 h-8 mt-6 bg-orange-600 bg-opacity-80 border  border-4 rounded-3xl rounded-tl border-amber-900 items-center 
