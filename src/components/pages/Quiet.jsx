...
//        <>
//         <div
//           className="bg-cover bg-black h-auto min-h-screen overflow-x-auto overflow-auto">
//           <Navbar/>
//           <div className="header"><h1 className='ml-6 mt-4 text-white text-center bold font-bold text-9xl'>NoireX</h1></div>
//           <div className="subheader"><h2 className='ml-6 text-white text-center text-2xl'>A Black Owned Directory</h2></div>
          
 
//           <div className="flex flex-col pt-20 space-y-8 mb-20">
//         <div className="flex space-x-10 justify-center">
//         <a href='/Eats'><div className='flex m-0 border border-4 rounded-3xl rounded-tl border-white transition-all duration-300 ease-in-out hover:bg-black hover:scale-105'>
//          <div className="w-[200px] h-[320px] bg-red-900 bg-opacity-80 flex p-5 rounded-3xl rounded-br rounded-tl rounded-tr justify-end flex-col">
...
//         </div>
//         </div></div>  
//         </div><img className='rounded-3xl rounded-tl rounded-bl' src={Image1} alt="Food" width="340px" height="200px"/></div></a>
