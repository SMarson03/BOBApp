      ...
      <div className="min-h-screen bg-yellow-600 flex items-center justify-center p-4">
        ...
        <div className="relative min-h-[75vh] w-[90vw] max-w-md bg-amber-50 shadow-xl rounded-xl p-8">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full bg-yellow-600 hover:bg-yellow-700 text-white font-bold py-2 rounded-md transition"
            >
              Sign Up
            </button>
          ...
          <p className="text-sm text-gray-600 text-center mt-4">
            ...
            <Link
              to="/Login"
              className="text-yellow-700 font-semibold hover:underline ml-1"
            >
              Sign in
            </Link>
