...
//   // --- Google Maps add-on (no layout changes) ---
...
//          <div key={index} onClick={() => openDirections(item)}>
...
//           <button
//             className="m-8 w-14 h-8 mt-6 bg-amber-50 bg-opacity-80 border border-2  border-black items-center 
//       flex justify-center text-sm text-black  "
//             onClick={(e) => e.stopPropagation()} // keep Visit behavior only
//           >
...
//           <div
//             key={index}
//             className="mb-4 justify-center border-b pb-2"
//             onClick={() => openDirections(item)}
//             role="button"
//             tabIndex={0}
//             onKeyDown={(e) => e.key === 'Enter' && openDirections(item)}
//           >
