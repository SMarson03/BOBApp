...
public class GreenUApplication {
	...
	CommandLineRunner runner() {
		return args -> {
			...
			Therapists therapists20 = new Therapists();
			Therapists therapists21 = new Therapists();
			Therapists therapists22 = new Therapists();
			Therapists therapists23 = new Therapists();
			Therapists therapists24 = new Therapists();
			Therapists therapists25 = new Therapists();
			Therapists therapists26 = new Therapists();
